...
/** Params shared by both Results and PremiumResults screens. */
export type AssessmentResultParams = {
...
export type AppStackParamList = {
  ...
  Results: AssessmentResultParams;
  /** Full PVGIS yield report — only accessible to Premium / Commercial users. */
  PremiumResults: AssessmentResultParams;
...
export type PremiumResultsScreenNavProp = NativeStackNavigationProp<AppStackParamList, 'PremiumResults'>;
export type PremiumResultsScreenRouteProp = RouteProp<AppStackParamList, 'PremiumResults'>;
